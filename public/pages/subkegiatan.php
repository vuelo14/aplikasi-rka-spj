...
$rka = $pdo->prepare('SELECT id, tahun, nomor_rka, nama_kegiatan FROM rka WHERE tahun = ? ORDER BY tahun DESC');
...
$subs = $pdo->prepare('SELECT s.*, r.tahun, r.nomor_rka, r.nama_kegiatan 
  FROM subkegiatan s 
